export const ProductService = {
  getProductsData() {
    return [
      ...
      {
        id: '1 987 301 013',
        name: 'Lâmpada, farol principal',
        description: 'H7 12V 55W',
        commercial_number: '12V55WH7XenonBlue',
        price: 8.34
      },
      {
        id: '1 987 302 079',
        name: 'Lâmpada, farol principal',
        description: 'H7 12V 55W Halogéneo',
        commercial_number: 'Blister1pcs1987301042',
        price: 33.07
      },
      {
        id: '3 397 006 837',
        name: 'Aerotwin Escova do limpa-vidros',
        description: '600mm à frente, do lado do condutor, Sem armação',
        commercial_number: 'AP24U',
        price: 12.78
      },
      {
        id: '3 397 013 455',
        name: 'AeroECO Escova do limpa-vidros',
        description: '600mm à frente, Sem armação',
        commercial_number: 'AE60',
        price: 9.34
      },
      {
        id: '0 986 473 071',
        name: 'Pinça de travão',
        description: 'Ferro fundido, 75mm, Eixo dianteiro, lado esquerdo',
        commercial_number: 'CR298',
        price: 70.48
      },
      {
        id: '0 986 473 099',
        name: 'Pinça de travão',
        description: 'Alumínio, 55mm, Eixo traseiro esquerdo',
        commercial_number: 'CR869',
        price: 91.85
      }
      // {
      //   id: '1000',
